...
describe('RemoteDataSource', () => {
    ...
    it('should catch an error when the getAll method fails', async () => {
        ...
        await expect(dataSource.getAll()).rejects.toThrowError('Get All Error Invalid URL');
    ...
    it('should reject with an error when getAll request fails', async () => {
        ...
        await expect(dataSource.getAll()).rejects.toThrowError('Request failed with status code 500');
    });
    ...
    it('should reject with an error when the GetById method fails', async () => {
        ...
        await expect(dataSource.getById('123')).rejects.toThrowError('Request failed with status code 500');
    ...
    it('should catch an error when the getById method fails', async () => {
        ...
        dataSource.url = 'httpa//example.com';
        dataSource.path = '/api/invalid21!@$^#:';
        await expect(dataSource.getById('1')).rejects.toThrowError('Get By Id Error Invalid URL');
    ...
    it('should reject with an error when getById request fails', async () => {
        ...
        await expect(dataSource.getById(id)).rejects.toThrowError('Request failed with status code 500');
    });
