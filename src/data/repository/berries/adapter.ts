// BerryAdapter.ts
import { berrySchema, Berry } from '../../schema/Berries'; // replace 'YourFileName' with the actual filename where Berry is defined
import { berryDTOSchema, BerryDTO } from '../../schema/Berries/DTO';
