...
import { PokemonItem, pokemonItemSchema } from '../../entities/Items'; // replace 'YourFileName' with the actual filename where PokemonItem is defined
import { pokemonItemDTOSchema, PokemonItemDTO } from '../../entities/Items/DTO';
